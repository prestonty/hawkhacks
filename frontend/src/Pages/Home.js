...
import {
  ...
  import { Heading, Box, Button, CardBody, Card, Text, ButtonGroup } from '@chakra-ui/react'
...
>
  {/* left box */}
      <Box my={0}>
        <Heading as='h1' size='xl' pl={10} py={2} noOfLines={2} mx={2} my={10}>Introducing a Decentralized Blockchain Education Platform</Heading>
